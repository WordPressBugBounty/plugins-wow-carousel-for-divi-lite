<?php
/**
 * Module Styles Trait for Image Carousel module.
 */
...
trait ModuleStylesTrait
{
    ...
    public static function module_styles($args)
    {
        ...
        if ('ticker' !== $carousel_type) {
            ...
            $custom_styles[] = [
                'atRules'     => false,
                'selector'    => "{$order_class} .dcf-container.dcf-image-carousel",
            ...
            // Text styles (image carousel specific).
            $title_color        = $attrs['module']['advanced']['titleColor']['desktop']['value'] ?? '';
            $subtitle_color     = $attrs['module']['advanced']['subtitleColor']['desktop']['value'] ?? '';
            $title_font_size    = $attrs['module']['advanced']['titleFontSize']['desktop']['value'] ?? '';
            $subtitle_font_size = $attrs['module']['advanced']['subtitleFontSize']['desktop']['value'] ?? '';
            ...
            if ($subtitle_color) {
                $custom_styles[] = [
                    'atRules'     => false,
                    'selector'    => "{$order_class} .dcf-image-subtitle",
                    'declaration' => "color:{$subtitle_color};",
                ];
            }
            if ($title_font_size) {
                $custom_styles[] = [
            ...
            if ($subtitle_font_size) {
                $custom_styles[] = [
                    'atRules'     => false,
                    'selector'    => "{$order_class} .dcf-image-subtitle",
                    'declaration' => "font-size:{$subtitle_font_size};",
                ];
            }
