...
$nav_html  = $show_nav  ? \DiviCarouselShared\V1\CarouselMarkup::navigation('dcf', $dc_labels) : '';
            ...
            $children = sprintf(
                '<div dir="%s" class="dcf-container dcf-image-carousel %s" ' . \DiviCarouselShared\V1\CarouselMarkup::region_attributes($dc_labels) . '><div class="swiper" data-swiper-config=\'%s\'><div class="swiper-wrapper">%s</div></div>%s%s%s</div>',
                esc_attr($sliding_dir),
                esc_attr(implode(' ', $classes)),
