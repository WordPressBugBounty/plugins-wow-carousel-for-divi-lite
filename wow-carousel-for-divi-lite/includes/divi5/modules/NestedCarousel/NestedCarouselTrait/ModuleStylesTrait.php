<?php
/**
 * Module Styles Trait for Nested Carousel module.
 */
...
trait ModuleStylesTrait
{
    public static function module_styles($args)
    {
        ...
        $arrow_icon_size     = $attrs['module']['advanced']['arrowIconSize']['desktop']['value'] ?? '18px';
        $arrow_color         = $attrs['module']['advanced']['arrowColor']['desktop']['value'] ?? '#333333';
        $arrow_bg            = $attrs['module']['advanced']['arrowBg']['desktop']['value'] ?? '#ffffff';
        $arrow_pos_y         = $attrs['module']['advanced']['arrowPosY']['desktop']['value'] ?? '50%';
        $arrow_pos_x         = $attrs['module']['advanced']['arrowPosX']['desktop']['value'] ?? '-20px';
        ...
        $arrow_border_radius = $attrs['module']['advanced']['arrowBorderRadius']['desktop']['value'] ?? '50%';
        ...
        // Vertical mode — fixed height for Swiper vertical direction.
        if ($is_vertical) {
            $carousel_height = $attrs['module']['advanced']['carouselHeight']['desktop']['value'] ?? '500px';
            $custom_styles[] = [
                'atRules'     => false,
